...
" Last Updated: Mon 12 Jun 2023 09:42:34 PM CEST
...
let s:t_Co = has('gui_running') ? -1 : get(g:, 'artesanal_t_Co', get(g:, 't_Co', exists('&t_Co') ? +&t_Co : 0))
...
if &background ==# 'dark'
  ...
  if has('nvim')
    hi DiagnosticInfo guifg=#90caf9 guibg=NONE gui=bold cterm=bold
    hi DiagnosticHint guifg=#69f0b9 guibg=NONE gui=bold cterm=bold
    hi DiagnosticWarn guifg=#ffeb3b guibg=NONE gui=bold cterm=bold
    hi DiagnosticError guifg=#ff616f guibg=NONE gui=bold cterm=bold
  endif
else
  " Light background
  if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if has('nvim')
    hi DiagnosticInfo guifg=#0961a8 guibg=NONE gui=bold cterm=bold
    hi DiagnosticHint guifg=#0e8756 guibg=NONE gui=bold cterm=bold
    hi DiagnosticWarn guifg=#cc6c0b guibg=NONE gui=bold cterm=bold
    hi DiagnosticError guifg=#b2000f guibg=NONE gui=bold cterm=bold
  endif
endif
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    if has('nvim')
      hi DiagnosticInfo ctermfg=153 ctermbg=NONE cterm=bold
      hi DiagnosticHint ctermfg=85 ctermbg=NONE cterm=bold
      hi DiagnosticWarn ctermfg=226 ctermbg=NONE cterm=bold
      hi DiagnosticError ctermfg=203 ctermbg=NONE cterm=bold
    endif
  else
    " Light background
    if !has('gui_running') && get(g:, 'artesanal_dimmed', 0)
    ...
    if has('nvim')
      hi DiagnosticInfo ctermfg=25 ctermbg=NONE cterm=bold
      hi DiagnosticHint ctermfg=29 ctermbg=NONE cterm=bold
      hi DiagnosticWarn ctermfg=166 ctermbg=NONE cterm=bold
      hi DiagnosticError ctermfg=124 ctermbg=NONE cterm=bold
    endif
  endif
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    if has('nvim')
      hi DiagnosticInfo ctermfg=Blue ctermbg=NONE cterm=bold
      hi DiagnosticHint ctermfg=Green ctermbg=NONE cterm=bold
      hi DiagnosticWarn ctermfg=DarkYellow ctermbg=NONE cterm=bold
      hi DiagnosticError ctermfg=Red ctermbg=NONE cterm=bold
    endif
  else
    " Light background
    if !has('gui_running') && get(g:, 'artesanal_dimmed', 0)
